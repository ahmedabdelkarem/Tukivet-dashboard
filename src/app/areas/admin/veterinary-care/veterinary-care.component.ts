...
@Component({
  selector: 'veterinary-care',
  templateUrl: './veterinary-care.component.html',
})
export class VeterinaryCareComponent {
  ...
  getAllCare(filter: paramsRequest) {
    this.dataSource.data = [];
    this.careService.getAllCare(filter).subscribe((res) => {
      console.log(res);
  ...
  getAllFilter() {
    this.careService.getAllFilter().subscribe((res) => {
      console.log(res);
